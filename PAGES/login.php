...
require 'config.php';
    if (isset($_POST["submit"])) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if ($correct_pass == 1) {
                $nat_id = $row['National_ID_no'];   // get the national id number from citizen_account table
                ...
                if ($row['verify_status'] == '1') {
                    ...
                    $_SESSION["logged_citizen"] = [
                        ...
                        'disablity' => $row_citizen['DISABILITY_TYPE']
                    ];
            ...
            $admin_result = mysqli_query($conn, "SELECT * FROM admin_account WHERE Email_Add = '$email' LIMIT 1");
            ...
            if (mysqli_num_rows($admin_result) > 0) {
                ...
                $admin_nat_id = $admin_row['National_ID_no']; // not use

                if ($admin_correct_pass == 1) {

                    if ($admin_row['verify_status'] == '1') {
