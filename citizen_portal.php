        ...
        if (mysqli_num_rows($sql_result) > 0) {
            while ($row = mysqli_fetch_assoc($sql_result)) {
                ...
                echo "<div class='btn-page'>
                            <button id='seeker' class='page-btn btn-see'>Looking for Kasambahay</button>
                        </div>
                ...
                $dbdis = $row_show['DISABILITY_TYPE'];
                $dbpwdnum = $row_show['PWD_ID_NO'];
                $dbseniornum = $row_show['SENIOR_ID_NO'];
                        ...
                        <form action='' method='POST' enctype='multipart/form-data'>
                            <div class='popup-sub-content'>
                                <div class='personal-info'>
                                    ...
                                    <div class='input-space'>
                                        <label for='dis'>Disability Type:</label>
                                        <input type='text' name='dis' value='$dbdis' id='dis'><br>
                                    </div>
                                    <div class='input-space'>
                                        <label for='pwdno'>PWD ID No.:</label>
                                        <input type='text' name='pwdno' value='$dbpwdnum' id='pwdno'><br>
                                    </div>
                                    <div class='input-space'>
                                        <label for='seniorno'>Senior ID No.:</label>
                                        <input type='text' name='seniorno' value='$dbseniornum' id='seniorno'><br>
                                    </div>
                                    <div class='input-space'>
