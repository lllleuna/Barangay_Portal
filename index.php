...
<body>
    ...
    <div class="services-container" > <!-- LIST OF SERVICES/CARE TO AVAIL -->
        <p class="servicelist-title">JOB FOR HIRE</p>
        
        <div class="service">
           <div class="icon-title">
                <i class="fa-solid fa-leaf"></i>
                <p class="care-title">Hardinero</p>
           </div>
            <p class="service-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
        </div>
        
        <div class="service">
            <div class="icon-title">
                <i class="fa-solid fa-person-dress"></i>
                <p class="care-title">Yaya</p>
            </div>
            <p class="service-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
        </div>
        ...
        <div class="service">
            <div class="icon-title">
                ...
                <p class="care-title">Taga-Luto</p>
            </div>
            <p class="service-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
        </div>
        ...
        <div class="service">
            <div class="icon-title">
                ...
                <p class="care-title">Taga-laba</p>
            </div>
            <p class="service-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
        </div>
        ...
        <div class="service">
            <div class="icon-title">
                ...
                <p class="care-title">All-around</p>
            </div>
            <p class="service-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
        </div>
